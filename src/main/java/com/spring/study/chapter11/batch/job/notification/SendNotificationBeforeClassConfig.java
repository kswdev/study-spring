...
import com.spring.study.chapter11.domain.booking.entity.BookingStatus;
...
import com.spring.study.chapter11.domain.notification.mapper.NotificationModelMapper;
...
public class SendNotificationBeforeClassConfig {
    ...
    public Job sendNotificationBeforeClassJob() {
        return jobs.get("sendNotificationBeforeClassJob")
    ...
    public Step addNotificationStep() {
        return steps.get("addNotificationStep")
    ...
    public Step sendNotificationStep() {
        return steps.get("sendNotificationStep")
